                                ...
                                <div class="card" style="padding: 15px; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4" runat="server">
                                            ...
                                            <asp:TextBox class="form-control" ID="txtCapacity" TabIndex="9" onkeydown="return preventEnterSubmit(event)" MaxLength="10" onKeyPress="return isNumberKey(event);" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <br />
                                            <asp:RegularExpressionValidator ID="regexValidator" runat="server" ControlToValidate="txtCapacity"
                                                ValidationExpression="^\d{1,10}$" ForeColor="Red" ErrorMessage="Please enter valid numeric capacity">                                              
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <asp:TextBox class="form-control" ID="txtinstallationNo1" TabIndex="13" onkeydown="return preventEnterSubmit(event)" onKeyPress="return restrictInput(event)" placeholder="Max no. of Installations is 150." MaxLength="3" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="margin-left: 15px !important; margin-right: 15px !important;">
                                                                        <asp:TextBox class="form-control" ID="txtinstallationNo3" TabIndex="15" onkeydown="return preventEnterSubmit(event)" onKeyPress="return restrictInput(event)" placeholder="Max no. of Installations is 150." MaxLength="3" autocomplete="off" runat="server" Style="margin-left: 18px"></asp:TextBox>
