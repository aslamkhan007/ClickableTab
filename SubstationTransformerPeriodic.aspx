    <%@ Page Title="" Language="C#" MasterPageFile="~/SiteOwnerPages/SiteOwner.Master" AutoEventWireup="true" CodeBehind="SubstationTransformerPeriodic.aspx.cs" Inherits="CEIHaryana.SiteOwnerPages.SubstationTransformerPeriodic" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        input#ContentPlaceHolder1_txtNOOfInstallation {
         ...
         input#ContentPlaceHolder1_File_NamePlateDoucment {
     padding: 2px;
 }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: center;">
                        <h7 class="card-title fw-semibold mb-4" id="maincard">
                            RATING OF INSTALLATIONS (SUBSTATION TRANSFORMER)
                        </h7>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="card-body" style="box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; padding: 25px 25px 25px 25px; margin-bottom: 25px; border-radius: 10px; margin-top: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3" id="Div171" runat="server" style="margin-top: -15px;">
                            ...
                            <asp:TextBox class="form-control" AutoPostBack="true" MaxLength="6" OnTextChanged="txtTransformerCapacity_TextChanged" ID="txtTransformerCapacity" onKeyPress="return isNumberKey(event);" onkeydown="return preventEnterSubmit(event)" placeholder="" autocomplete="off" TabIndex="3" runat="server" Style="margin-left: 18px"></asp:TextBox>
                        ...
                        <div class="col-3" id="Div65" runat="server" style="margin-top: 15px;">
                            ...
                            <asp:DropDownList class="form-control  select-form select2" TabIndex="4" runat="server" AutoPostBack="true" ID="ddlyearOfManufacturing" selectionmode="Multiple" Style="width: 100% !important">
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator107" ForeColor="Red" ControlToValidate="ddlyearOfManufacturing" runat="server" ErrorMessage="Please Select manufacturing Type" InitialValue="0" ValidationGroup="Submit"></asp:RequiredFieldValidator>
    ...
    <div class="row">
        <div class="col-md-4" id="Div6" runat="server">
            ...
            <asp:FileUpload ID="File_NamePlateDoucment" runat="server" CssClass="form-control" />
        ...
        <div class="col-md-4" id="Div7" runat="server">
            ...
            <asp:FileUpload ID="File_sitephotograph" runat="server" CssClass="form-control" Style="padding: 2px;" />
        </div>
    </div>
</div>
                <div class="row">
